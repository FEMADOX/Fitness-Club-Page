        ...
        <div className="space-y-8 relative">
          ...
          <Card className="p-8 relative bg-white dark:bg-gray-800 shadow-lg">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 italic leading-relaxed">
              "Gale is an amazing trainer as well as a great person. She is so flexible when it
              comes to my crazy work schedule and makes sure to always fit me in. Every day she
              pushes me harder towards my goals."
            </p>
            <div className="mt-6 border-t border-gray-200 dark:border-gray-700 pt-4">
              <h4 className="text-xl font-bold text-gray-900 dark:text-white">Jessica Parker</h4>
